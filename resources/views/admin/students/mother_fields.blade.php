    ...
    <div id="collapse2" class="panel-collapse collapse">
      <div class="panel-body">
        ...
        <div class="{{ $errors->has('mother_cnic') ? 'text-danger' : '' }} form-group col-md-3" id="mother_cnic_div">
            ...
            {!! Form::number('mother_cnic', old('mother_cnic') ,['class' => 'form-control']) !!}
        ...
        <div class="{{ $errors->has('mother_education') ? 'text-danger' : '' }} form-group col-md-3" id="mother_education_div">
            ...
            {!! Form::select('mother_education', array('' => 'Select a Qualification') + \Config::get('admin.education_level_array'), old('mother_education'), ['class' => 'form-control select2']) !!}
        ...
        <div class="{{ $errors->has('mother_professional_status') ? 'text-danger' : '' }} form-group col-md-3" id="mother_professional_status_status_div">
            ...
            {!! Form::select('mother_professional_status', array('' => 'Select a Professional Status') + \Config::get('admin.professional_status_array'), old('mother_professional_status'), ['class' => 'form-control select2']) !!}
